...
def scrape(model, db_name, db_user, db_password):
    ...
    scraper_model = scraper_metamodel.model_from_file(model)
...
if __name__ == "__main__":    
    scrape(model=sys.argv[1], db_name=sys.argv[2], db_user=sys.argv[3], db_password=sys.argv[4])
